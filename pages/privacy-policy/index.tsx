    ...
    <>
      <S.Layout>
        ...
        <S.Text>
          <Body2>제1조(목적)</Body2>
          <Body4>
            ootd.zip (이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하
            '회사 서비스')를 이용하는 개인 (이하 '이용자' 또는 '개인')의
            정보(이하 '개인정보')를 보호하기 위해, 개인정보보호법, 정보통신망 이
            용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련
            법령을 준수하고, 서비스 이용자의 개 인정보 보호 관련한 고충을
            신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이
            개인정보처 리방침 (이하 '본 방침')을 수립합니다.
          </Body4>
          <br />

          <Body2>제2조(개인정보 처리의 원칙)</Body2>
          <Body4>
          ...
          <Body2>제7조(개인정보의 이용)</Body2>
          <Body4>회사는 개인정보를 다음 각 호의 경우에 이용합니다.</Body4>
          <Body4>1. 공지사항의 전달 등 회사운영에 필요한 경우</Body4>
          <Body4>
            2. 이용문의에 대한 회신, 불만 처리 등 이용자에 대한 서비스 개선을
            위한 경우
          </Body4>
          <Body4>3. 회사의 서비스를 제공하기 위한 경우</Body4>
          <Body4>
            4. 법령 및 회사 약관을 위반하는 회원에 대한 이용 제한 조치, 부정
            이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한
            방지 및 제재를 위한 경우
          </Body4>
          <Body4>5. 신규 서비스 개발을 위한 경우</Body4>
          <Body4>
          ...
          <Body2>제8조(개인정보의 보유 및 이용기간)</Body2>
          <Body4>
          ...
          <Body2>제9조(법령에 따른 개인정보의 보유 및 이용기간)</Body2>
          <Body4>
          ...
          <Body4>가. 계약 또는 청약철회 등에 관한 기록 : 5년</Body4>
          <Body4>나. 대금결제 및 재화 등의 공급에 관한 기록 : 5년</Body4>
          <Body4>다. 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년</Body4>
          <Body4>라. 표시·광고에 관한 기록 : 6개월</Body4>
          <Body4>2. 통신비밀보호법에 따른 보유정보 및 보유기간</Body4>
          <Body4>가. 웹사이트 로그 기록 자료 : 3개월</Body4>
          <Body4>3. 전자금융거래법에 따른 보유정보 및 보유기간</Body4>
          <Body4>가. 전자금융거래에 관한 기록 : 5년</Body4>
          <Body4>4. 위치정보의 보호 및 이용 등에 관한 법률</Body4>
          <Body4>가. 개인위치정보에 관한 기록 : 6개월</Body4>
          <br />

          <Body2>제10조(개인정보의 파기원칙)</Body2>
          <Body4>
          ...
          <Body2>제13조(광고성 정보의 전송 조치)</Body2>
          <Body4>
          ...
          <Body4>
            ...
            수신자와 거래한 것과 동종의 재화 등에 대한 영리목적의 광고 성 정보를
            전송하려는 경우
          </Body4>
          <Body4>
          ...
          <Body4>
            ...
            동의를 철회한 경우에는 영리목적 의 광고성 정보를 전송하지 않으며
          ...
          <Body4>
            가. 광고성 정보 수신자의 수신거부 또는 수신동의의 철회를 회피
            방해하는 조치
          </Body4>
          <Body4>
            나. 숫자부호 또는 문자를 조합하여 전화번호·전자우편주소 등 수신자의
            연락처를 자동으로 만들어 내 는 조치
          </Body4>
          <Body4>
          ...
          <Body2>제15조(회사의 개인정보 관리)</Body2>
          <Body4>
            회사는 이용자의 개인정보를 처리함에 있어 개인정보가 분실, 도난,
            유출, 변조, 훼손 등이 되지 아니하 도록 안전성을 확보하기 위하여
            필요한 기술적·관리적 보호대책을 강구하고 있습니다.
          </Body4>
          <br />

          <Body2>제16조(삭제된 정보의 처리)</Body2>
          <Body4>
            회사는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된
            개인정보는 회사가 수집하는 개인정 보의 보유 및 이용기간"에 명시된
            바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리
            하고 있습니다.
          </Body4>
          <br />

          <Body2>제17조(비밀번호의 암호화)</Body2>
          <Body4>
            이용자의 비밀번호는 일방향 암호화하여 저장 및 관리되고 있으며,
            개인정보의 확인, 변경은 비밀번호 를 알고 있는 본인에 의해서만
            가능합니다.
          </Body4>
          <br />

          <Body2>제18조(해킹 등에 대비한 대책)</Body2>
          <Body4>
            1. 회사는 해킹, 컴퓨터 바이러스 등 정보통신망 침입에 의해 이용자의
            개인정보가 유출되거나 훼손되는 것 을 막기 위해 최선을 다하고
            있습니다.
          </Body4>
          <Body4>
          ...
          <Body4>
            3. 회사는 만일의 사태에 대비하여 침입차단시스템을 이용하여 보안에
            최선을 다하고 있습니다.
          </Body4>
          <Body4>
            4. 회사는 민감한 개인정보를 수집 및 보유하고 있는 경우를 암호화 통신
            등을 통하여 네트워크상에서 개 인정보를 안전하게 전송할 수 있도록
            하고 있습니다.
          </Body4>
          <br />

          <Body2>제19조(개인정보 처리 최소화 및 교육)</Body2>
          <Body4>
            회사는 개인정보 관련 처리 담당자를 최소한으로 제한하며, 개인정보
            처리자에 대한 교육 등 관리적 조 치를 통해 법령 및 내부방침 등의
            준수를 강조하고 있습니다.
          </Body4>
          <br />

          <Body2>제20조(개인정보 유출 등에 대한 조치)</Body2>
          <Body4>
            회사는 개인정보의 분실, 도난・유출(이하 "유출 등"이라 한다) 사실을
            안 때에는 지체 없이 다음 각 호의 모든 사항을 해당 이용자에게 알리고
            방송통신위원회 또는 한국인터넷진흥원에 신고합니다.
          </Body4>
          <Body4>1. 유출 등이 된 개인정보 항목</Body4>
          <Body4>2. 유출 등이 발생한 시점</Body4>
          <Body4>3. 이용자가 취할 수 있는 조치</Body4>
          <Body4>4. 정보통신서비스 제공자 등의 대응 조치</Body4>
          <Body4>5. 이용자가 상담 등을 접수할 수 있는 부서 및 연락처</Body4>
          <br />

          <Body2>제21조 (개인정보 유출 등에 대한 조치의 예외)</Body2>
          <Body4>
            회사는 전조에도 불구하고 이용자의 연락처를 알 수 없는 등 정당한
            사유가 있는 경우에는 회사의 홈페 이지에 30일 이상 게시하는 방법으로
          ...
          <Body4>
            ...
            저장하고 수시로 불러오는 개인정보 자동수집장치(이하 '쿠키')를
            사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용
            자의 웹브라우저(PC 및 모바일을 포함)에게 보내는 소량의 정보이며
            이용자의 저장공간에 저장되기도 합니다.
          </Body4>
          <Body4>
            2. 이용자는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서
            이용자는 웹브라우저에서 옵션을 설정함 으로써 모든 쿠키를 허용하거나,
            쿠키가 저장될 때마다 확인을 거치거나, 아니면 모든 쿠키의 저장을 거부
            할 수도 있습니다.
          </Body4>
          <Body4>
          ...
          <Body2>제23조(쿠키 설치 허용 지정 방법)</Body2>
          <Body4>
          ...
          <Body2>제24조(회사의 개인정보 보호 책임자 지정)</Body2>
          <Body4>
          ...
          <Body2>제25조(권익침해에 대한 구제방법)</Body2>
          <Body4>
            1. 정보주체는 개인정보침해로 인한 구제를 받기 위하여
            개인정보분쟁조정위원회, 한국인터넷진흥원 개인 정보침해신고센터 등에
          ...
          <Body2>부칙</Body2>
          <Body4>제1조 본 방침은 2024.04.11.부터 시행됩니다.</Body4>
          <br />
        </S.Text>
      </S.Layout>
    </>
...
PrivacyPolicy.Layout = ({ children }: AppLayoutProps) => {
  return <>{children}</>;
};

PrivacyPolicy.Layout.displayName = 'PrivacyPolicy';
